...
def train():
    ...
    scheduler = MultiStepLR(optimizer, milestones=[25,50,75,100,125,150], gamma=0.5)
    ...
    for epoch in tqdm(range(num_epochs)):
        ...
        for images, masks,_ in tqdm(val_loader):
            ...
            vloss3 = criterion5(outputs, masks) #+ criterion2(outputs, masks)
            #vloss = vloss2 + vloss3
        ...
        #torch.save(net.state_dict(), 'Weights/cp_bce_interchange_custom_lr_4_mix_{}_{}.pth.tar'.format(epoch+1, val_loss2.avg))
        val_epoch_loss = val_loss1.avg
        # Save Model
        if(min_val_loss > val_epoch_loss):
            min_val_loss = val_epoch_loss
            torch.save(net,'/home/naveen/v3/Cs_Project/SaveModel/'+str(epoch)+'.pth') 
